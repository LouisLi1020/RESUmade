  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm text-slate-500">Up to {maxSkills}</span>
      </div>
      <p className="text-sm text-slate-600 mb-4">Add up to {maxSkills} skills (e.g. JavaScript, Project Management).</p>
